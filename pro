...
local Window = Library.CreateLib("Coems", "Aqua")
...
MainSection:NewButton("Rayx", "idk what to put", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/SpaceYes/Lua/Main/DaHood.Lua'))()
end)

MainSection:NewToggle("Fast", "Flash", function(state)
    if state then
...
MainSection:NewButton("Agent", "idk what to put", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/mrhackerman35297/AgentCC/main/Launch.lua"))()
end)


--LOCAL PLAYER
local Player = Window:NewTab("Player fast")
local PlayerSection = Player:NewSection("Coems pro")

PlayerSection:NewSlider("Walkspeed", "fast as boy come get me", 500, 0, function(s)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

PlayerSection:NewSlider("jumpower", "fast as boy come get me", 350, 50, function(s)
    game.Players.LocalPlayer.Character.Humanoid.jumpower = s
end)

PlayerSection:NewButton("If", "idk what to put", function()
...
--Other
Other = Window:NewTab("idk")
OtherSection = Other:NewSection("Coems pro")

OtherSection:NewButton("Admin", "YAY", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/fatesc/fates-admin/main/main.lua"))();
end)

OtherSection:NewButton("breaking point", "YAY", function()
...
MainSection:NewButton("mm2 point", "YAY", function()
